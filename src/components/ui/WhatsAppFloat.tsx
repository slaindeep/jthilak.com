  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      ...
      >
        ...
        <span className="absolute -top-2 -left-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          !
        </span>
      </button>
    </div>
