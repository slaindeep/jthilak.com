...
export const metadata = {
  ...
  description:
    "Join TFF Legal team in Dubai, UAE. Explore career opportunities for experienced lawyers, legal consultants, and support professionals in our growing legal practice.",
  keywords:
    "TFF Legal careers, legal jobs Dubai, law firm jobs UAE, legal consultant positions, lawyer opportunities Dubai",
};
...
const jobPositions: JobPosition[] = [
  {
    ...
    experience: "5+ years",
    description:
      "We&apos;re seeking an experienced Senior Legal Counsel to join our growing practice. You&apos;ll work on complex corporate transactions, provide strategic legal guidance to clients, and contribute to our fractional general counsel services.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Join our dynamic team as a Legal Associate. You'll support senior lawyers on various matters including contract drafting, legal research, and client advisory services.",
    requirements: [
      "LLB or equivalent legal degree",
  ...
  },
  {
    ...
    experience: "3+ years",
    description:
      "Drive growth initiatives and client relationships for our legal practice. You'll identify new business opportunities and support our expansion across the Middle East region.",
    requirements: [
...
const companyValues = [
  {
    title: "Excellence",
    description:
      "We deliver exceptional legal solutions with the highest professional standards.",
    icon: "⭐",
  },
  {
    title: "Innovation",
    description:
      "We embrace technology and modern approaches to enhance legal service delivery.",
    icon: "💡",
  },
  {
    title: "Integrity",
    description:
      "We maintain unwavering ethical standards in all our professional relationships.",
    icon: "🛡️",
  },
  {
    title: "Collaboration",
    description:
      "We work as a cohesive team to achieve the best outcomes for our clients.",
    icon: "🤝",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Build your career with TFF Legal, where innovation meets
              excellence. Be part of a dynamic team shaping the future of legal
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We foster an environment where legal professionals can thrive,
              innovate, and make a meaningful impact on our clients&apos;
              success.
            </p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Work with cutting-edge legal technology and digital
                        tools
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Cross-border transactions and diverse client portfolio
                      </p>
                    </div>
                  </div>
              ...
              <div>
                <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-xl p-8">
                  ...
                  <p className="text-gray-700 mb-6">
                    Join a firm with a proven track record of success across the
                    Middle East, where your expertise will contribute to shaping
                    the legal landscape.
                  </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Explore our current opportunities and take the next step in your
              legal career
            </p>
          </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {position.requirements.map((req, idx) => (
                        ...
                        >
                          <svg
                            className="w-4 h-4 mr-2 mt-0.5 text-teal-600 flex-shrink-0"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
          ...
          {activePositions.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                ...
                we&apos;re always interested in connecting with talented legal
                professionals. Submit your information below and we&apos;ll
      ...
      <section id="apply" className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Submit your application or connect with us for future
              opportunities
            </p>
          </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <a
                      href=" https://www.linkedin.com/company/tff-legal"
                      target="_blank"
      ...
      <section className="py-16 bg-gradient-to-r from-teal-600 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            We&apos;d love to discuss how you can contribute to our growing
            legal practice
          </p>
          <a
            href="/contact"
